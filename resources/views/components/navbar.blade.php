<nav class="bg-white shadow-md py-4 px-4 md:px-8 flex justify-between items-center">
    ...
    <div class="hidden md:flex space-x-6 text-gray-700 font-semibold">
        ...
        <a href="{{route('infaq')}}" class="hover:text-green-600">Infaq Masjid</a>
        <a href="{{route('event-mesjid')}}" class="hover:text-green-600">Events Masjid</a>
        <a href="{{route('berita')}}" class="hover:text-green-600">Berita Masjid</a>
