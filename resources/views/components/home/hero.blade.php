<section class="relative h-screen flex items-center justify-center bg-no-repeat bg-cover bg-center overflow-hidden"
    ...
    <div class="relative z-10 text-center max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center gap-4 mb-16">
            <a href="#" class="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2">
            ...
            <a href="#" class="px-8 py-3 bg-white hover:bg-gray-50 text-green-600 font-semibold border-2 border-green-600 rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
