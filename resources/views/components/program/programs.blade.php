        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach ($programs as $program)
                <div class="group bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 p-6 text-center">
                    <div class="w-16 text-white h-16 mx-auto mb-4 rounded-xl border {{ $program    ['color'] }} flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300">
