...
<section class="relative bg-gradient-to-b from-green-700 to-green-800 text-white py-24 px-6 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        <div class="mb-2">
            <span class="inline-block px-4 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium">Kegiatan Masjid</span>
        </div>

        <h1 class="text-4xl md:text-5xl font-bold mb-6">
            <span class="bg-clip-text text-transparent bg-gradient-to-r from-white to-green-200">Event Masjid</span>
        </h1>

        <h2 class="text-2xl md:text-3xl font-semibold mb-8 text-green-200">
            Untuk Kemakmuran Umat
        </h2>

        <p class="text-lg text-green-100 max-w-2xl mx-auto mb-10">
            Jadwal kegiatan dan acara terkini Masjid Al-Ikhlash untuk meningkatkan keimanan dan ukhuwah islamiyah.
        </p>
