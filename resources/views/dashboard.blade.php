...
@section('content')
    <header class="bg-green-800 text-white py-2 px-4 md:px-8 flex justify-between items-center text-sm">
    ...
    <nav class="bg-white shadow-md py-4 px-4 md:px-8 flex justify-between items-center">
        <div class="flex items-center">
            <img src="{{ asset('resources/img/image.png') }}" alt="Logo DKM" class="h-12 mr-3 rounded-full shadow-md">
